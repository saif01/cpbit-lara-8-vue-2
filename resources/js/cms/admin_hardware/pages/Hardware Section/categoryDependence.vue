                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tbody>
                            <tr v-for="singleData in allData.data" :key="singleData.id">
                                ...
                                <td v-for="dependent in singleData.dependent" :key="dependent.id">{{ dependent.name }}</td>
                                ...
                                <v-col cols="12">
                                    <div class="d-flex align-center justify-content-between">
                                        <span v-for="field in dependentField" :key="field.id">
                                            <v-checkbox :label="field.name" v-model="form.field_id" :value="field.id"
    ...
    export default {
        ...
        methods: {
            ...
            dependentCategory() {
                ...
                axios.get(this.currentUrl + '/categoryDependency').then(response => {
