                        ...
                        <form @submit.prevent="editmode ? updateData() : createData()">
                            ...
                            <v-row align-content="center">
                                <v-col md="12">
                                    ...
                                    <v-autocomplete dense solo :items="allCategory" v-model="form.cat_id" label="Select Category" :rules="[v => !!v || 'Category name is required!']" required></v-autocomplete>
                                </v-col>
                                <v-col md="12">
                                    <div class="text-danger" v-if="form.errors.has('name')" v-html="form.errors.get('name')" />
                                    <v-text-field v-model="form.name" label="Enter Subcategory Name" :rules="namRules" counter="100" placeholder="Enter Subcategory Name" 
