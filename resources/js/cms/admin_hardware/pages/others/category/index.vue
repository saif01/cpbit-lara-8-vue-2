                    ...
                    <v-form v-model="valid" ref="form">
                        <form @submit.prevent="editmode ? updateData() : createData()">
                            ...
                            <v-row align-content="center">
                                <v-col md="12">
                                    <v-text-field v-model="form.name" label="Enter Category Name" :rules="namRules" counter="100" placeholder="Enter Category Name" 
                                        required></v-text-field>
                                        <div class="text-danger" v-if="form.errors.has('name')" v-html="form.errors.get('name')" />
                                </v-col>
                                <v-col md="12">
                                    <v-text-field v-model="form.label" label="Dependent label Name" :rules="namRules" counter="100" placeholder="Enter category dependent label Name"
                                        ></v-text-field>
                                        <div class="text-danger" v-if="form.errors.has('label')" v-html="form.errors.get('label')" />
                                </v-col>
                            </v-row>
