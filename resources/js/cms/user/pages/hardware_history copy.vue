        ...
        <v-dialog v-if="allRemarks" v-model="remarksDialog">
            <v-card>
                ...
                <v-card-text>
                        ...
                        <tbody>
                            <tr v-for="(item, index) in allRemarks.remarks" :key="index">
                                <!-- <div> -->
                                    <td class="text-center">
                                        ...
                                        <v-btn v-if="item.process == 'Closed' && item.dam_apply"
                                            @click="damQuotationModal = true " outlined color="indigo">View Delivery
                                            Details
                                        </v-btn>
                                    </td>
                                ...
                                <!-- <div v-if="item.process == 'HO Service'">
                                    <div v-for="(item2, index) in  allRemarks.ho_remarks" :key="index">
                                        HO Remarks
                                        ...
                                        <td v-html="item2.details"></td>
                                        <td class="text-center">
                                            <span v-if="item2.document">
                                                <a v-if="item2.document" :href="docPath+item2.document"
                                                    class="btn btn-info btn-sm text-white" download>
                                                    <v-icon color="white" small>mdi-paperclip</v-icon> Document
                                                </a>
                                            </span>
                                        ...
                                        <td class="text-center">
                                            <span
                                                v-if="item2.created_at">{{ item2.created_at | moment("MMMM Do YYYY, h:mm a") }}</span><br>
                                            <span v-if="item2.makby"
                                                class="text-muted small">--{{ item2.makby.name }}</span>
                                        </td>
                    ...
                    <!--Start ho_remarks -->
                    <!-- <div v-if="(item.process == 'HO Service')">
                        <div v-for="(item2, index) in  item2.ho_remarks" :key="index">
                            <table class="table mb-0 bg-info text-white rounded">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span v-if="(item2.process == 'Damaged')"
                                            class="text-danger bg-white rounded">Damaged</span>
                                        <span v-else-if="(item2.process == 'Closed')"
                                            class="text-danger bg-white rounded">Closed</span>
                                        <span v-else>{{ item2.process }}</span>
                                    </td>
                                    <th>Document:</th>
                                    <td>
                                        <span v-if="item2.document">
                                ...
                                <tr>
                                    <th>By:</th>
                                    <td>
                                        <button class="btn btn-secondary btn-sm" v-if="item2.makby"
                                            @click="currentUserView(item2.makby)">
                                            <v-avatar size="20">
                                                <img v-if="item2.makby.image"
                                                    :src="'/images/users/small/' + item2.makby.image" alt="image">
                                            </v-avatar> {{ item2.makby.name }}
                                        </button>
                                    </td>
                                    <th>Action At:</th>
                                    <td><span
                                            v-if="item2.created_at">{{ item2.created_at | moment("MMMM Do YYYY, h:mm a") }}</span>
                                    </td>
                                </tr>
                            
                                <tr>
                                    <th>Remarks:</th>
                                    <td colspan="3" v-html="item2.details"></td>
                                </tr>
                            </table>
