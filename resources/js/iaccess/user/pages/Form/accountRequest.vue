                ...
                <v-form v-model="valid" ref="form">
                    <form @submit.prevent="createData()">
                        ...
                        <v-stepper-content step="2">
                            ...
                            <div class="h5 py-2 bg-dark text-white text-center" block>Access For</div>
                            <v-row>
                                <v-col cols="4" v-for="(data, index) in accessOptions" :key="index">
                                    <v-checkbox multiple v-model="form.access_for" :label="data.text" :value="data.value" color="indigo"></v-checkbox>
                                </v-col>
                            </v-row>
    ...
    export default {
        data() {
            return {
                ...
                currentUrl: '/iaccess/form/account',
