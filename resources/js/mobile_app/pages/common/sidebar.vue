    ...
    <div>
        ...
        <v-navigation-drawer app dark v-model="drawer" class="bg_gradient">
            <v-list-item class="px-2" link href="/">
                <v-list-item-icon>
                    <img src="/all-assets/common/icon/mobileapp.png" alt="" height="50px" contain>
                </v-list-item-icon>
                <v-list-item-title>Mobile App Admin</v-list-item-title>
            </v-list-item>
            <v-divider></v-divider>
            ...
            <v-list dense nav>
                ...
                <v-list-item link router :to="{name: 'Dashboard'}" exact>
                 ...
                 <v-list-item link router :to="{name: 'AppUser'}">
                    <v-list-item-icon>
                ...
                <v-list-item link router :to="{name: 'AppVersion'}">
                    <v-list-item-icon>
                ...
                <v-list-item link router :to="{name: 'AppRole'}">
                    <v-list-item-icon>
