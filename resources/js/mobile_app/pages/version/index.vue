        ...
        <div class="card">
            <div class="card-header">
                ...
                <div>
                    ...
                    <a href="/api/mobileapp/version?appname=abc" target="_blank" > {{ baseUrl+'/api/mobileapp/version?appname=abc' }}</a>
                </div>
            </div>
                    ...
                    <table class="table table-bordered">
                        <thead class="text-center">
                            <tr>
                                ...
                                <th>
                                    <a href="#" @click.prevent="change_sort('version')">Version</a>
                                    <span v-if="sort_direction == 'desc' && sort_field == 'version'">&uarr;</span>
                                    <span v-if="sort_direction == 'asc' && sort_field == 'version'">&darr;</span>
                                </th>
                                <th>Created By</th>
                                <th>Action</th>
                            </tr>
                ...
                <v-card-text>
                    <v-form v-model="valid">
                        <form @submit.prevent="editmode ? updateData() : createData()">
                            ...
                            <v-row>
                                <v-col cols="12">
                                    <v-text-field type="text" label="App Name:"
                                        :rules="[v => !!v || 'App Name is required!']" v-model="form.name" required>
                                    </v-text-field>
                                    <div v-if="form.errors.has('name')" v-html="form.errors.get('name')" />
                                </v-col>

                                <v-col cols="12">
                                    <v-text-field type="text" label="App Version:"
                                        :rules="[v => !!v || 'App Version is required!']" v-model="form.version" required>
                                    </v-text-field>
                                    <div v-if="form.errors.has('version')" v-html="form.errors.get('version')" />
                                </v-col>
