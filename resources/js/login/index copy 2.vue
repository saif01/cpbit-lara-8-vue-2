                    ...
                    <v-card class="pb-4">
                        ...
                        <form @submit.prevent="login()">
                            <v-card-text>
                                ...
                                <v-btn block depressed class="light-blue darken-4 text-white" :loading="loading" type="submit">
                                    <v-icon dense>
                                         mdi-login
                                    </v-icon>
                                    Login
                        ...
                        <div class="my-3">
                            ...
                            <span>
                                <router-link :to="{ name: 'Register' }" class="text_color">
                                    <u>Create an account</u>
                                </router-link>
                            </span>
                        </div>
                        <div>
                            <router-link to=""> <v-icon>mdi-account-plus</v-icon> Not registered yet? Create an account</router-link>
                        </div>
                            <div @click="register()" class="mb-2 mt-5 d-flex align-items-center justify-content-center register"><v-icon>mdi-account-plus</v-icon> Register </div>
