                    ...
                    <table class="table table-bordered">
                        <thead class="text-center">
                            <tr>
                                ...
                                <th>
                                    <a href="#" @click.prevent="change_sort('code')">Code</a>
                                    <span v-if="sort_direction == 'desc' && sort_field == 'code'">&uarr;</span>
                                    <span v-if="sort_direction == 'asc' && sort_field == 'code'">&darr;</span>
                                </th>
                    ...
                    <v-form v-model="valid" ref="form">
                        <form @submit.prevent="editmode ? updateData() : createData()">
                            ...
                            <v-row align-content="center">
                                <v-col md="12">
                                    <v-text-field v-model="form.name" label="Enter Operation Name" :rules="reqRules"
                                        required></v-text-field>
                                        <div class="text-danger" v-if="form.errors.has('name')" v-html="form.errors.get('name')" />
                                </v-col>

                                <v-col md="12">
                                    <v-text-field type="number" v-model="form.code" :counter="2" label="Enter Operation code" :rules="codeRules" required>
                                        </v-text-field>
                                    <div class="text-danger" v-if="form.errors.has('code')" v-html="form.errors.get('code')" />
                                </v-col>
                            </v-row>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                //current page url
                currentUrl: '/sms/admin/operation',
