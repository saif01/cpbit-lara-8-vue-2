                ...
                <div v-if="allData.data">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-center">
                            <thead>
                                <th>
                                    <a href="#" @click.prevent="change_sort('name')">Group Name</a>
                    ...
                    <v-form v-model="valid" ref="form">
                        <form @submit.prevent="editmode ? updateData() : createData()">
                            ...
                            <v-row>
                                ...
                                <v-col cols="12">
                                    <v-text-field v-model="form.name" label="Enter Group Name" :rules="networkRules" required></v-text-field>
                                </v-col>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                currentUrl: '/network/admin/all-group',
