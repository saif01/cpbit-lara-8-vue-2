                        ...
                        <tbody>
                            <tr v-for="singleData in allData.data" :key="singleData.id">
                                <td class="text-center">
                                    ...
                                    <v-btn class="ma-2" @click="deleteData(singleData.id, 'new')" color="error" elevation="20" small>
                                        <v-icon small>mdi-delete-empty</v-icon> Delete
                                    </v-btn>

                                    <v-btn class="ma-2" @click="restoreData(singleData.id, 'new')" color="success" elevation="20" small>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                //current page url
                currentUrl: '/inventory/admin/delete/new-product',
