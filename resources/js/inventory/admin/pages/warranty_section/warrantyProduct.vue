                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-center">
                            <thead>
                                ...
                                <th>
                                    <a href="#" @click.prevent="change_sort('warranty')">Warranty</a>
                                    <span v-if="sort_direction == 'desc' && sort_field == 'warranty'">&uarr;</span>
                                    <span v-if="sort_direction == 'asc' && sort_field == 'warranty'">&darr;</span>
                                </th>
                                <th>
                            ...
                            <tbody>
                                <tr v-for="singleData in allData.data" :key="singleData.id">
                                    ...
                                    <td>
                                        <span
                                            v-if="singleData.warranty">{{ singleData.warranty | moment("from", singleData.purchase ) }}</span>
                                        <span v-else class="error--text">N/A</span>
                                    </td>
                                    <td>
        ...
        methods: {
            ...
            exportExcel() {
                ...
                axios({
                    ...
                    let repName = 'Inventory Waranty Product List -' + this.$moment(new Date()).format(
                        'YYYY-MMM-DD');
