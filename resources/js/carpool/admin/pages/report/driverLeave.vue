<template>
    <div>
        <v-card>
            <v-card-title>All Driver Leave Records</v-card-title>
    ...
    export default {
        ...
        methods: {
            ...
            getResults(page = 1) {
                ...
                axios.get(this.currentUrl+'/driver-leave?page=' + page +
