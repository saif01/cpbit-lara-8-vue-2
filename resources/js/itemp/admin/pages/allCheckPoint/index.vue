                    ...
                    <v-form v-model="valid" ref="form">
                        <form @submit.prevent="editmode ? updateData() : createData()">
                            ...
                            <v-row>
                                ...
                                <v-col cols="12">
                                    <v-text-field v-model="form.name" label="Enter checkpoint Name" :rules="checkpointRules" required></v-text-field>
                                </v-col>
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                checkpointRules:[v => !!v || 'This field is required!'],


                //current page url

                currentUrl: '/itemp/admin/all-checkpoints',
