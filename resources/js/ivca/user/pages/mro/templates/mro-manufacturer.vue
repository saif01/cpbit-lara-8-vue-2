...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                form: new Form({
                    ...
                    equipment_1: null,
                    equipment_1_remarks: null,
                    equipment_2: null,
                    equipment_2_remarks: null,
                    equipment_3: null,
                    equipment_3_remarks: null,
        ...
        methods: {
            ...
            // Template
            auditTempalte() {
                axios.post(this.currentUrl + '/template/manufacturer').then(response => {
            ...
            // Audit Data Refresh
            auditDataRefresh() {
                axios.get(this.currentUrl + '/manufacturer/audit_data/' + this.token).then(response => {
        ...
        created() {
            ...
            console.log('Token: ' + this.token, this.userType, 'iamgeUploadAccess:', this.iamgeUploadAccess)
