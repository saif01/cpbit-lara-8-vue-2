<template>
    <div>
        ...
        <p class="h3 text-center">The survey report of the Supplier and Retailer</p>
                ...
                <v-form v-model="valid">
                    <form @submit.prevent="storageDataUpdate()">
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.storage_1" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('storage_1') }" :rules="mroRetailerRules"
                                    required>
                                </v-select>
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.storage_2" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('storage_2') }" :rules="mroRetailerRules"
                                    required>
                                </v-select>
                                <div class="small text-danger" v-if="form.errors.has('storage_1')"
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.storage_3" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('storage_3') }" :rules="mroRetailerRules"
                                    required>
                                </v-select>
                                <div class="small text-danger" v-if="form.errors.has('storage_1')"
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.storage_4" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('storage_4') }" :rules="mroRetailerRules"
                                    required>
                                </v-select>
                                <div class="small text-danger" v-if="form.errors.has('storage_1')"
                        ...
                        <div class="col-12">
                            <v-btn v-if="!auditComplete" type="submit" block dense :loading="storage_loading" small
                                color="primary">
        ...
        <div class="mt-5">
            <v-card :class="{ 'submit-complete': production_qs_complete }">
                <v-card-title>Production planning / control product quality and service</v-card-title>
                <v-form v-model="valid">
                    <form @submit.prevent="productionQsDataUpdate()">
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.production_qs_1" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('production_qs_1') }"
                                    :rules="mroRetailerRules" required>
                                </v-select>
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.production_qs_2" :items="options" class="mb-1"
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.production_qs_3" :items="options" class="mb-1"
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.production_qs_4" :items="options" class="mb-1"
                        ...
                        <div class="col-12">
                            <v-btn v-if="!auditComplete" type="submit" block dense :loading="production_qs_loading"
                                small color="primary">
                                <v-icon>mdi-pencil-outline</v-icon> Update
                            </v-btn>
                        </div>
        ...
        <!-- Safety -->
        <div class="mt-5">
            <v-card :class="{ 'submit-complete': safety_complete }">
                ...
                <v-form v-model="valid">
                    <form @submit.prevent="safetyDataUpdate()">
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.safety_1" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('safety_1') }" :rules="mroRetailerRules"
                                    required>
                                </v-select>
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.safety_2" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('safety_2') }" :rules="mroRetailerRules"
                                    required>
                                </v-select>
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.safety_3" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('safety_3') }" :rules="mroRetailerRules"
                                    required>
                                </v-select>
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.safety_4" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('safety_4') }" :rules="mroRetailerRules"
                                    required>
                                </v-select>
                        ...
                        <div class="col-12">
                            <v-btn v-if="!auditComplete" type="submit" block dense :loading="safety_loading" small
                                color="primary">
                                <v-icon>mdi-pencil-outline</v-icon> Update
                            </v-btn>
                        </div>
        ...
        <div class="mt-5">
            <v-card :class="{ 'submit-complete': env_sur_con_complete }">
                ...
                <v-form v-model="valid">
                    <form @submit.prevent="envSurConDataUpdate()">
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.env_sur_con_1" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('env_sur_con_1') }"
                                    :rules="mroRetailerRules" required>
                                </v-select>
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.env_sur_con_2" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('env_sur_con_2') }"
                                    :rules="mroRetailerRules" required>
                                </v-select>
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.env_sur_con_3" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('env_sur_con_3') }"
                                    :rules="mroRetailerRules" required>
                                </v-select>
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.env_sur_con_4" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('env_sur_con_4') }"
                                    :rules="mroRetailerRules" required>
                                </v-select>
                        ...
                        <div class="col-12">
                            <v-btn v-if="!auditComplete" type="submit" block dense :loading="env_sur_con_loading" small
                                color="primary">
                                <v-icon>mdi-pencil-outline</v-icon> Update
                            </v-btn>
                        </div>
        ...
        <div class="mt-5">
            <v-card :class="{ 'submit-complete': cooperate_complete }">
                ...
                <v-form v-model="valid">
                    <form @submit.prevent="cooperateDataUpdate()">
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.cooperate_1" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('cooperate_1') }" :rules="mroRetailerRules"
                                    required>
                                </v-select>
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.cooperate_2" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('cooperate_2') }" :rules="mroRetailerRules"
                                    required>
                                </v-select>
                        ...
                        <v-card-text class="ml-2">
                            ...
                            <div>
                                <v-select v-model="form.cooperate_3" :items="options" class="mb-1"
                                    :class="{ 'is-invalid': form.errors.has('cooperate_3') }" :rules="mroRetailerRules"
                                    required>
                                </v-select>
                        ...
                        <div class="col-12">
                            <v-btn v-if="!auditComplete" type="submit" block dense :loading="cooperate_loading" small
                                color="primary">
                                <v-icon>mdi-pencil-outline</v-icon> Update
                            </v-btn>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div label="Group Image:" v-if="iamgeUploadAccess">
                                <v-file-input prepend-icon="mdi-camera"
                                    @change="uploadImageByName($event, 'group_image')"
                                    label="Choose or drop Image here..." accept=".jpg, .png, .jpeg" :rules="imageRule">
                                </v-file-input>
                        ...
                        <div class="col-md-6">
                            <div label="Vendor Image:" v-if="iamgeUploadAccess">
                                <v-file-input prepend-icon="mdi-camera"
                                    @change="uploadImageByName($event, 'vendor_image')"
                                    label="Choose or drop Image here..." accept=".jpg, .png, .jpeg" :rules="imageRule">
                                </v-file-input>
    ...
    export default {
        ...
        data() {
            return {
                ...
                mroRetailerRules: [v => !!v || 'This Field is required!'],
                imageRule: [
                    v => this.iamgeUploadAccess || 'This Field is required',
                ],
        ...
        methods: {
            ...
            // Template
            auditTempalte() {
                axios.post(this.currentUrl + '/template/retailer').then(response => {
            ...
            // Audit Data Refresh 
            auditDataRefresh() {
                axios.get(this.currentUrl + '/retailer/audit_data/' + this.token).then(response => {
            ...
            storageDataUpdate() {
                ...
                this.overlay = true
                this.form.post(this.currentUrl + '/retailer/storage_store/' + this.token + '/' + this.userType)
                    .then(response => {
            ...
            productionQsDataUpdate() {
                ...
                this.overlay = true
                this.form.post(this.currentUrl + '/retailer/production_qs_store/' + this.token + '/' + this
            ...
            safetyDataUpdate() {
                ...
                this.overlay = true
                this.form.post(this.currentUrl + '/retailer/safety_store/' + this.token + '/' + this.userType).then(
                    response => {
            ...
            envSurConDataUpdate() {
                ...
                this.overlay = true
                this.form.post(this.currentUrl + '/retailer/env_sur_con_store/' + this.token + '/' + this.userType)
                    .then(response => {
            ...
            cooperateDataUpdate() {
                ...
                this.overlay = true
                this.form.post(this.currentUrl + '/retailer/cooperate_store/' + this.token + '/' + this.userType)
                    .then(response => {
            ...
            finalDataUpdate() {
                ...
                this.overlay = true
                this.form.post(this.currentUrl + '/retailer/final_store/' + this.token + '/' + this.userType)
                    .then(response => {
        ...
        created() {
            ...
            console.log('Token: ' + this.token, this.iamgeUploadAccess, this.userType, )
