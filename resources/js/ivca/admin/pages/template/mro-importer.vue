<template>
<div>
    <h3 class="text-muted text-center">---: MRO Importer Template :---</h3>
        <form @submit.prevent="templateInfoStore()">
            ...
            <v-card>
                ...
                <v-card-title>Import planning / control product quality and service</v-card-title>
                <v-card-subtitle>This Sections All Questions</v-card-subtitle>
    ...
    export default {
        ...
        methods: {
            ...
            templateInfoData(){
                ...
                this.form.get( this.currentUrl + '/mro_importer_data' ).then( response=>{
            ...
            templateInfoStore(){
                ...
                this.form.post( this.currentUrl + '/mro_importer_store' ).then(response=>{
