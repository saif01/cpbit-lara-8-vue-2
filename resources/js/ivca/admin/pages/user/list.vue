                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    ...
                                    <span v-if="sort_direction == 'desc' && sort_field == 'designation'">&uarr;</span>
                                    <span v-if="sort_direction == 'asc' && sort_field == 'designation'">&darr;</span>
                                </th>
                                <th>
                        ...
                        <tbody>
                            <tr v-for="singleData in allData.data" :key="singleData.id">
                                <td class="text-center">
                                    <div v-if="singleData.image_small">
                                        <v-avatar size="76">
                                            <img :src="'/'+singleData.image_small" alt="Image">
                                        </v-avatar>
