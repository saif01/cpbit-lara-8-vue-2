    ...
    <div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-6">
                        <h3 class="card-title">Food Audit Report</h3>
                    </div>
                    ...
                    <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                            <tr v-for="singleData in allData.data" :key="singleData.id">
                                ...
                                <td>
                                    <span v-for="(item, i) in singleData.audits" :key="i">
                                        <!-- {{ item.id }}, -->
                                        <button v-if="item.status == 1" @click="reportSummary(item.id)" class="btn btn-info btn-sm m-1">Audit by {{ item.auditordata.name }}</button>
                                    </span>
                                </td>
            ...
            getDirectResults(page = 1) {
                ...
                axios.get(this.currentUrl + '/index?page=' + page +
                    ...
                    .then(response => {
                        ...
                        //     if(response.data.audits[0].status == 1){
