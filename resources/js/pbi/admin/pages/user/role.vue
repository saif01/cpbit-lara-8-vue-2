                ...
                <v-card-text>
                    <v-form v-model="valid" ref="form">
                        <form @submit.prevent="editmode ? updateData() : createData()">
                            ...
                            <v-row>
                                <v-col cols="12">
                                    <v-text-field type="text" label="Report Name:" :rules="nameRule" counter="300"
                                        v-model="form.name" placeholder="Enter Report Name" required>
                                    </v-text-field>
                                    <div class="text-danger" v-if="form.errors.has('name')"
                                        v-html="form.errors.get('name')" />
                                </v-col>
                                <v-col cols="12">
                                    <v-text-field type="text" label="Power BI Link:" :rules="linkRule" counter="1000"
                                        v-model="form.link" placeholder="Enter link (https://app.powerbi.com)" required>
                                    </v-text-field>
