                                                            ...
                                                            <div>
                                                                <div style="margin: auto;padding: 1.4rem;background-color: white;border-radius: 8px;">
                                                                    ...
                                                                    <div style="color: #3a70d4">
                                                                        ...
                                                                        <div>
                                                                            Abul Kalam Azad   <span style="margin-left: 5rem"> Contact: 01766 668 845  </span>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;font-family:arial,helvetica,sans-serif;" align="left">
                                                            ...
                                                            <div>
                                                                <div style="text-align:center;color:#999999;align-items:center;font-size:12px;">
                                                                    <strong>
                                                                        <a href="https://www.cpbangladesh.com" style="text-decoration:none; color:#999999">CP Bangladesh</a>
                                                                    </strong>
                                                                    <div style="color: #999999">Holding No: E-236, Ward No: 07, Chandra,
                                                                    ...
                                                                    <div>
                                                                        <div style="color: #999999;text-align:center;">
                                                                            <span> © 2022 
                                                                            <a href="" style="text-decoration:none;color:#999999;">
                                                                                <strong> CPB-IT | </strong>
                                                                            </a>
                                                                            </span>
