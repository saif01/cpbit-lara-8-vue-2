...
<body>
    <div class="container-fluid" style="border:3px solid black">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3>Account/Authority Request</h3>
        ...
        <div class="my-5">
            <div class="h5 text-center w-50 py-2 bg-dark text-white">Access For</div>
            <div class="my-2">{{$newData->access_for}}</div>
        </div>
        ...
        <div class="my-5">
            <div class="d-flex justify-content-between">
                <div>
                    <div class="h5 text-center py-2 bg-dark text-white d-block">Module</div>
