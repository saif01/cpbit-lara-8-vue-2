...
<div class="container p-0">
    <div class="text-center font-weight-bold" style="border-bottom: 2px solid black">
        The survey report of the supplier Manufacturer
    </div>
...
<div class="container p-0">
    <table class="text-center table_posts" style="border-bottom: 1px solid black">
        ...
        {{-- 5 --}}
        <tr>
            <th class="text-left cell_left">Machinery Equipment</th>
            <td></td>
            <td></td>
            <td class="border_right_none"></td>
        </tr>
        <tr>
            ...
            <td class="border_right_none">{{ $singleAuditReport->auditData->equipment_1_remarks }}</td>
        </tr>
        <tr>
            <td class="text-left">{{ $templateData->equipment_2 }}</td>
            <td>4</td>
            <td>{{ $singleAuditReport->auditData->equipment_2 }}</td>
            <td class="border_right_none">{{ $singleAuditReport->auditData->equipment_2_remarks }}</td>
        </tr>
        <tr>
            <td class="text-left">{{ $templateData->equipment_3 }}</td>
            <td>4</td>
            <td>{{ $singleAuditReport->auditData->equipment_3 }}</td>
            <td class="border_right_none">{{ $singleAuditReport->auditData->equipment_3_remarks }}</td>
        </tr>
        <tr>
            <th class="text-right font-weight-bold">
                Total
    ...
    <div class="table-responsive">
        <table class="text-center table_posts" style="border-bottom: 1px solid black">
            ...
            <tr>
                ...
                <td>{{ $singleAuditReport->equipmentSection->totalMaxVal }}</td>
                <td>{{ $singleAuditReport->equipmentSection->totalActualVal }}</td>
                <td class="border_right_none">{{ $singleAuditReport->equipmentSection->avgSectionVal }} %</td>
            </tr>
            <tr>
