<table>
    <tr>
        <th style="font-weight: bold; text-align:center" colspan="4">The survey report of the supplier Manufacturer</th>
    </tr>
    ...
    <tr>
        <th rowspan="6" colspan="4">
            ...
            <br>
            Surveyer : {{$singleAuditReport->auditData->auditordata->name ?? ''}} &nbsp;&nbsp;&nbsp; ||
            &nbsp;&nbsp;&nbsp; Position : {{$singleAuditReport->auditData->auditordata->designation ?? ''}}
            &nbsp;&nbsp;&nbsp; || &nbsp;&nbsp;&nbsp; Department :
            {{$singleAuditReport->auditData->auditordata->business_unit ?? ''}}
        </th>
    </tr>
    <tr></tr>
    <tr></tr>
    ...
    <tr>
        <td style="font-weight: bold;background-color:#1e755d; color:white;">Sum Total</td>
        <td>{{ $singleAuditReport->sumOfSectionMaxVal }}</td>
        <td>{{ $singleAuditReport->sumOfSectionActualVal }}</td>
        <td rowspan="2"></td>
    </tr>
    <tr>
        <td  style="font-weight: bold;background-color:#1e755d; color:white;">Average %</td>
