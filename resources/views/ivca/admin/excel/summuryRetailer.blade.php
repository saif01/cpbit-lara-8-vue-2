<table>
    ...
    <tr>
        <td style="font-weight: bold; text-align:center" colspan="4">The survey report of the supplier retailer</td>
    </tr>
    ...
    <tr>
        <td style="font-weight: bold">5. To cooperate with the company :</td>
    </tr>
    <tr>
        <td>
            @foreach ($finalResult->allData as $item)
