...
class CreateIvcaAuditMroManufacturersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ivca_audit_mro_manufacturers', function (Blueprint $table) {
            $table->id();
            $table->string('token');
            ...
            $table->integer('equipment_1')->nullable();
            $table->string('equipment_1_remarks')->nullable();
            $table->integer('equipment_2')->nullable();
            $table->string('equipment_2_remarks')->nullable();
            $table->integer('equipment_3')->nullable();
            $table->string('equipment_3_remarks')->nullable();
    ...
    {
        Schema::dropIfExists('ivca_audit_mro_manufacturers');
    }
}
