...
class CreatePbiFarmPoultrySalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pbi_farm_poultry_sales', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pbi_farm_poultry_sales');
    }
}
