...
class CreateIvcaTemplateMroImportersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ivca_template_mro_importers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ivca_template_mro_importers');
    }
}
