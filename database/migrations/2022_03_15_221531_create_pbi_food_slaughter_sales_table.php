...
class CreatePbiFoodSlaughterSalesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pbi_food_slaughter_sales', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pbi_food_slaughter_sales');
    }
}
