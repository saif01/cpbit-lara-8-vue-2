...
class CreateIvcaTemplateImportersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ivca_template_importers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ivca_template_importers');
    }
}
