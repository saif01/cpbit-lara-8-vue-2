...
class CreateIvcaAuditMroRetailersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ivca_audit_mro_retailers', function (Blueprint $table) {
            $table->id();
            $table->string('token');
    ...
    {
        Schema::dropIfExists('ivca_audit_mro_retailers');
    }
}
