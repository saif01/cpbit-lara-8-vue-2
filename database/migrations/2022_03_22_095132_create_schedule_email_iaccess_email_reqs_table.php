...
class CreateScheduleEmailIaccessEmailReqsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('schedule_email_iaccess_email_reqs', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('email_form_id')->nullable();
    ...
    {
        Schema::dropIfExists('schedule_email_iaccess_email_reqs');
    }
}
