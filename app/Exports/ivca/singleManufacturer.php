...
class singleManufacturer implements FromView, ShouldAutoSize, WithEvents, WithStyles
{
    public $data;
    public $data2;
    ...
    public function view(): View
    {
        ...
        return view('ivca.admin.excel.singleManufacturer', compact('singleAuditReport','templateData'));
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('A51:D51')
                ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
                ...
                $event->sheet->getDelegate()->getStyle('A43')
                ->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_RIGHT);
    ...
    public function styles(Worksheet $sheet)
    {
       ...
       $styleArray = [
        ...
        $sheet->getStyle('A8:D45')->applyFromArray($styleArray);

        $sheet->getStyle('A50:D58')->applyFromArray($styleArray);
        ...
        $sheet->getStyle('A1:D58')->applyFromArray($wholeArray);
    }
