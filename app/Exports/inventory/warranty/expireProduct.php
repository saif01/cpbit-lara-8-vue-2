...
namespace App\Exports\inventory\warranty;
...
class expireProduct implements FromView, ShouldAutoSize, WithEvents
{
    public $data;
    ...
    public function view(): View
    {
        ...
        $product =  $this->data;
        return view('inventory.admin.reports.expireProduct', compact('product'));
    }
